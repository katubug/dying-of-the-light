...
StartupEvents.registry('item', event => {
    ...
    event.create('sneaking_terror_poppet').texture('kubejs:item/poppet').displayName("Sneaking Terror Poppet")
    event.create('rotting_stalker_poppet').texture('kubejs:item/poppet').displayName("Rotting Stalker Poppet")
