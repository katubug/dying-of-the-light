...
FTBQuestsEvents.customReward('25210CEFBACC7CCF', event =>{
    if (event.player.persistentData.insightCount == null) event.player.persistentData.insightCount = 0
...
FTBQuestsEvents.customReward('354CF419EB53165B', event =>{
    if (event.player.persistentData.insightCount < 2) return
...
FTBQuestsEvents.customReward('7B4B415748A14BE7', event =>{
    if (event.player.persistentData.insightCount < 5) return
...
FTBQuestsEvents.customReward('15FC502EDB664303', event =>{
    if (event.player.persistentData.insightCount < 6) return
...
FTBQuestsEvents.customReward('0DF32BFB6729D13D', event =>{
    if (event.player.persistentData.insightCount < 1) return
...
FTBQuestsEvents.customReward('7C5AF71554A0867E', event =>{
    if (event.player.persistentData.insightCount < 10) return
...
FTBQuestsEvents.customReward('619F2635AB57056C', event =>{
    if (event.player.persistentData.insightCount < 20) return
...
FTBQuestsEvents.customReward('2D3A7150C6454E58', event =>{
    if (event.player.persistentData.insightCount < 3) return
...
FTBQuestsEvents.customReward('70D41D478BA1A77A', event =>{
    if (event.player.persistentData.insightCount < 7) return
...
FTBQuestsEvents.customReward('456BEDDA420CC26C', event =>{
    if (event.player.persistentData.insightCount < 15) return
